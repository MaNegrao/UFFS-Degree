...
REDOcheck = []
    ...
    #[words.findall(linha)[0]] = nome da transação    
    #[words.findall(linha)[1]] = nome da variavel
    #[words.findall(linha)[2]] = valor antigo
    #[words.findall(linha)[3]] = valor novo
...
variaveis = {}
for i in range(0,len(valores),2): #Iniciar primeiros valores de A B C D E F
